 ...
 */
public class CategoryPostgresDao implements ICategoryDao{
    ...
    public CategoryPostgresDao(DataSource dataSource) {
        this.dataSource = dataSource;
    }

    public CategoryPostgresDao() {
        Context ctx;

        try {
            ctx=new InitialContext();
            dataSource=(DataSource) ctx.lookup("java:comp/env/jdbc/postgresql");
        }
